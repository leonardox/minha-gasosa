...
public class Abastecimento implements Comparable<Abastecimento> {
    ...
    public Abastecimento getCopy(){
        Abastecimento a = new Abastecimento();
        a.id = id;
        a.dataAbastecimento = dataAbastecimento;
        a.precoTotal = precoTotal;
        a.precoCombustivel = precoCombustivel;
        a.litros = litros;
        a.odometro = odometro;
        a.tanqueCheio = tanqueCheio;
        return a;
    }
